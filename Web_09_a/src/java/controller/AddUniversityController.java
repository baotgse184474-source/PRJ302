...
public class AddUniversityController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String s_foundedYear = request.getParameter("s_foundedYear");
            String address = request.getParameter("address");
            String city = request.getParameter("city");
            String region = request.getParameter("region");
            String type = request.getParameter("type");
            String s_totalStudents = request.getParameter("s_totalStudents");
            String s_totalFaculties = request.getParameter("s_totalFaculties");
            String s_isDraft = request.getParameter("s_isDraft");
            ...
            if (s_totalStudents.isEmpty()) {
                error += ("CHua nhap ToalStudents <br/>");
            }
            ...
            s_isDraft = s_isDraft.trim();
            if (s_isDraft.isEmpty()) {
                error += ("CHua nhap Draft <br/>");
            }
